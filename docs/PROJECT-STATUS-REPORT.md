...
| Nondumiso Mbuli | A, database schema and auth endpoints | `nondumisombuli16` | 2 (1 author, 1 co-author) | 1 | "Implement nearest responder selection" (algorithm work) and "Add automatic database seeding for demo accounts" (Pair A core foundation: automated database initialization and synthetic account provisioning for Railway/local MySQL) |
